...
<main role="main" class="container">
  ...
  <div class="starter-template">
    <br>
    <p class="lead">Cette épreuve nécessite de se connecter à l'adresse <b>127.0.0.1</b> sur le port <b>1337</b></p>
    <br>
    <br>
    <p>
    ...
    <div class="collapse" id="indice2">
      <div class="card card-body">
        Toujours regarder l'aide d'un logiciel avec "logiciel.exe -h" ou "logiciel.exe --help"
      </div>
    </div>
    <p>
    ...
    <div class="collapse" id="indice3">
      <div class="card card-body">
        Pour se connecter à un serveur avec netcat, la syntaxe est : netcat IP PORT
      </div>
    </div>
  </div>
...
<div class="fixed-bottom mx-auto" style="width: 200px;">
  <nav aria-label="...">
    <ul class="pagination">
      <li class="page-item">
        <a class="page-link" href="epreuve10.php">Précédent</a>
      </li>

      <li class="page-item">
        <a class="page-link" href="epreuve12.php">Suivant</a>
      </li>
    </ul>
  </nav>
</div>
