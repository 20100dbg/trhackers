...
<main role="main" class="container">
  ...
  <div class="starter-template">
    <br>
    <p class="lead">Cette image cache quelque chose</p>


    <a class="btn btn-primary" href="fichiers/stegano2.png" _target="blank">Télécharger le fichier</a>
    ...
    <div class="collapse" id="indice1">
      <div class="card card-body">
        exiftool ou HxD pour les masochistes
      </div>
    </div>
    <p>
    ...
    <div class="collapse" id="indice2">
      <div class="card card-body">
        Une image n'est pas qu'un tas de pixels
      </div>
    </div>
    <p>
    ...
    <div class="collapse" id="indice3">
      <div class="card card-body">
        Les métadonnées peuvent comporter des informations arbritraires
      </div>
    </div>
  </div>
...
<div class="fixed-bottom mx-auto" style="width: 200px;">
  <nav aria-label="...">
    <ul class="pagination">
      <li class="page-item">
        <a class="page-link" href="epreuve8.php">Précédent</a>
      </li>

      <li class="page-item">
        <a class="page-link" href="epreuve10.php">Suivant</a>
      </li>
    </ul>
  </nav>
</div>
